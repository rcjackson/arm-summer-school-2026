...
```{figure} ../images/headshots/obrien-headshot.png
:width: 250px
...
| :--------: | :---------: | :-----------: | :---: |
| Joe O'Brien | Argonne National Laboratory | TBD | [Professional Website](https://www.anl.gov/profile/joseph-obrien) <br> [Github Link](https://github.com/jrobrien91) |

```

```{figure} ../images/headshots/collis-headshot.jpg
:width: 250px
